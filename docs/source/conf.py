...
import os
import sys
sys.path.insert(0, os.path.abspath('../../src/alfred3_reaction_times'))


# -- Project information -----------------------------------------------------

project = 'alfred3-reaction-times'
copyright = '2022, Marius Teller'
...
html_theme_options = {
    "repository_url": "https://github.com/mate-code/alfred-reaction-times",
    "use_repository_button": True,
}

html_title = "Alfred3 Reaction Times"
html_logo = "../../src/alfred3_reaction_times/static/img/alfred_logo_color.png"
...
def linkcode_resolve(domain, info):
    ...
    return f"https://github.com/mate-code/alfred-reaction-times/blob/main/src/{filename}.py"
